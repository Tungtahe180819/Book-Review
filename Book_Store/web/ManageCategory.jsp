...
<html lang="en">
    ...
    <body>
                ...
                <div class="col-sm-7 col-md-5">
                    <div class="manager_search_box">
                        <form action = "" method = "get">
                            <button type="button" onclick="location.href = 'addCategory'" class="btn btn-default main-action pull-right"><i class="fa fa-plus">&nbsp;</i>Thêm</button>
        ...
        <form id="managerform" action="deleteCate" method="post">
            <section>
                <div class="container">
                    <div class="row">
                                    ...
                                    <tbody>
                                        <c:forEach items = "${listCate}" var = "item">
                                            <tr>
                                                ...
                                                <td>${item.cId}</td>
                                                <td><a href="details?pid=${item.cId}">${item.cName}</a></td>



                                                <td class="cart_action">
                                                    <a class="cart_edit" href="editCate?pid=${item.cId}"><i class="fa fa-edit"></i></a>
                                                    <a class="cart_delete" href="removeCate?id=${item.cId}"><i class="fa fa-times"></i></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
