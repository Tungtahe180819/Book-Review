                                ...
                                <div class="form-two">
                                    <form id="addproductform" style="width: 200%" action="addproduct" method="post">
                                        <section class="add-header">
                                            ...
                                            <input type="text" name="image" placeholder="Ảnh Bìa*" id="imageInput" required>
                                        </section>
                                        <input type="hidden" name="username" value="${sessionScope.loginedUser.username}">
                                        <textarea name="description" placeholder="Mô tả sản phẩm*" id="editor" rows="10" required>${book.description}</textarea>
